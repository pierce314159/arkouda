...
class Strings:
    ...
    regex_dict: Dict[str, Tuple[pdarray, pdarray, pdarray]]
        Dictionary storing information on matches
        Keys - regex patterns
    ...
    def print_cached_regex_patterns(self):
        """
        Prints the regex patterns for which we have cached the match positions
        """
    ...
    def slice(self, pattern: Union[bytes, str_scalars], return_match_origins: bool = False) -> Union[Strings, Tuple]:
        ...
        ----------
        pattern: str_scalars
            The regex pattern to find matches for
        ...
        -------
        Strings
            new Strings object containing only pattern matches
